...
class MPC(Node):
    ...
    def __init__(self):
        ...
        ref_path_tracker = '/visualization_marker_array'
        # Pose subscriber
        ...
        self.ref_vis = self.create_publisher(Marker, ref_path_tracker, 1)
        self.markerArray = Marker()
    ...
    def get_vehicle_state(self, pose_msg):
        ...
        _, _, vehicle_state.yaw = tf_transformations.euler_from_quaternion(quat)
